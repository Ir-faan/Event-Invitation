...
import { CustomSectionRenderer } from "@/components/invitation/custom-section-renderer";
...
function CountdownPreview({ section, exampleMode = false }: { section: InvitationSection; exampleMode?: boolean }) {
  ...
  return (
    <section className="invite-preview-section preview-countdown" data-preview-section={section.id}>
      {exampleMode && <ExampleSectionLabel>{sectionDefinitions[section.type].name}</ExampleSectionLabel>}
      <span className="preview-garden-portal preview-portal-left" aria-hidden="true"><img src="/templates/rose-afterglow/rose-afterglow.webp" alt="" loading="lazy" decoding="async" /></span>
      <span className="preview-garden-portal preview-portal-right" aria-hidden="true"><img src="/templates/rose-afterglow/rose-afterglow.webp" alt="" loading="lazy" decoding="async" /></span>
