...
import styles from "./coastal-reverie.module.css";
import { SeatingArrangement, type SeatingAssignment } from "@/components/invitation/seating-arrangement";
    ...
    <main className={`${styles.invitation} ${phase === "flash" || phase === "gone" ? styles.invitationReady : ""}`} id="invitation-top">
      <div className={`${styles.envelopeIntro} ${phase === "sealed" ? styles.sealed : phase === "opening" ? styles.opening : phase === "flash" ? styles.flash : styles.gone}`} aria-hidden={phase === "gone"}>
        ...
        <div className={`${styles.envelopePanel} ${styles.envelopePanelLeft}`} aria-hidden="true">
          <picture>
            <source media="(max-width: 760px)" srcSet="/templates/coastal-reverie/envelope/mobile.webp" />
            <img src="/templates/coastal-reverie/envelope/desktop.webp" alt="" />
          </picture>
        </div>
      ...
      <section className={styles.hero} aria-labelledby="couple-names">
        <div className={styles.heroImage}><img src="/templates/coastal-reverie/coastal-reverie.webp" alt="Sunlit coastal garden overlooking the sea" /></div>
      ...
      <section className={styles.countdownSection} id="counting" aria-labelledby="countdown-title">
        <div className={`${styles.gardenPortal} ${styles.portalLeft}`} aria-hidden="true"><img src="/templates/rose-afterglow/rose-afterglow.webp" alt="" /></div>
        <div className={`${styles.gardenPortal} ${styles.portalRight}`} aria-hidden="true"><img src="/templates/rose-afterglow/rose-afterglow.webp" alt="" /></div>
      ...
      <section className={styles.storySection} aria-labelledby="story-title">
        <div className={`${styles.storyBloom} ${styles.storyBloomLeft}`} aria-hidden="true"><img src="/templates/rose-afterglow/rose-afterglow.webp" alt="" /></div>
        <div className={`${styles.storyBloom} ${styles.storyBloomRight}`} aria-hidden="true"><img src="/templates/rose-afterglow/rose-afterglow.webp" alt="" /></div>
