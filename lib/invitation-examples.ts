...
const generatedPhotos = {
  oliveGarden: "/examples/photos/olive-garden.webp",
  burgundyHenna: "/examples/photos/burgundy-henna.webp",
  dustyBlueHall: "/examples/photos/dusty-blue-hall.webp",
  lilacGarden: "/examples/photos/lilac-garden.webp",
} as const;

const existingPhotos = {
  hennaHands: "/invitation/heroes/interactive/henna-hands.webp",
  orchid: "/invitation/heroes/interactive/orchid-bouquet.webp",
  islandWalk: "/invitation/heroes/interactive/island-walk.webp",
  bouquet: "/invitation/heroes/interactive/bouquet.webp",
  gardenWalk: "/invitation/heroes/interactive/garden-walk.webp",
  hands: "/invitation/heroes/interactive/hands.webp",
} as const;
...
export const invitationExamples: InvitationExample[] = [
  createExample({
    ...
    thumbnail: "/examples/thumbnails/ivory-promise.webp",
    palette: "beige",
    firstName: "Aaliyah",
    secondName: "Zayd",
    date: "2027-02-20",
  ...
  createExample({
    ...
    thumbnail: "/examples/thumbnails/olive-serenity.webp",
    palette: "olive",
    firstName: "Mariam",
    secondName: "Imraan",
    date: "2027-04-10",
  ...
  createExample({
    ...
    thumbnail: "/examples/thumbnails/dusty-blue-elegance.webp",
    palette: "dusty-blue",
    firstName: "Safiyyah",
    secondName: "Yusuf",
    date: "2027-06-19",
  ...
  createExample({
    ...
    thumbnail: "/examples/thumbnails/burgundy-romance.webp",
    palette: "burgundy",
    firstName: "Ayesha",
    secondName: "Hamza",
    date: "2027-08-13",
  ...
  createExample({
    ...
    eventLabel: "Nikkah + Dinner",
    thumbnail: "/examples/thumbnails/blush-reverie.webp",
    palette: "pink",
    firstName: "Sumayyah",
    secondName: "Ridwaan",
    date: "2027-10-23",
  ...
  createExample({
    ...
    eventLabel: "Mehendi + Nikkah + Walimah",
    thumbnail: "/examples/thumbnails/lavender-whispers.webp",
    palette: "lilac",
    firstName: "Fatimah",
    secondName: "Umar",
    date: "2027-12-18",
  ...
  createExample({
    ...
    eventLabel: "Nikkah + Walimah",
    thumbnail: "/examples/thumbnails/pearl-garden.webp",
    palette: "beige",
    firstName: "Zainab",
    secondName: "Ismail",
    date: "2028-01-29",
  ...
  createExample({
    ...
    thumbnail: "/examples/thumbnails/midnight-bloom.webp",
    palette: "burgundy",
    firstName: "Sarah",
    secondName: "Rayyaan",
    date: "2028-03-17",
  ...
  createExample({
    ...
    thumbnail: "/examples/thumbnails/golden-nikkah.webp",
    palette: "olive",
    firstName: "Inaya",
    secondName: "Zakariya",
    date: "2028-05-27",
  ...
  createExample({
    ...
    thumbnail: "/examples/thumbnails/lilac-moonlight.webp",
    palette: "lilac",
    firstName: "Hana",
    secondName: "Adam",
    date: "2028-07-21",
